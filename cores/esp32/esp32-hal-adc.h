 ...
 * */
uint16_t CanalogRead(uint8_t pin);
//uint16_t analogRead(uint8_t pin);  // for maker watch function
 
/*
 * Set the resolution of CanalogRead return values. Default is 12 bits (range from 0 to 4096).
 * If between 9 and 12, it will equal the set hardware resolution, else value will be shifted.
 * Range is 1 - 16
 *
 * Note: compatibility with Arduino SAM
 */
void CanalogReadResolution(uint8_t bits);
