...
extern void IRAM_ATTR __CpinMode(uint8_t pin, uint8_t mode)
{
...
extern void IRAM_ATTR __CdigitalWrite(uint8_t pin, uint8_t val)
{
...
extern int IRAM_ATTR __CdigitalRead(uint8_t pin)
{
    if(pin < 32) {
...
extern void CpinMode(uint8_t pin, uint8_t mode) __attribute__ ((weak, alias("__CpinMode")));
extern void CdigitalWrite(uint8_t pin, uint8_t val) __attribute__ ((weak, alias("__CdigitalWrite")));
extern int CdigitalRead(uint8_t pin) __attribute__ ((weak, alias("__CdigitalRead")));
