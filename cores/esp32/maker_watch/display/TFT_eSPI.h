...
#include "SPI.h"
  ...
  #define DC_D // No macro allocated so it generates no code
    ...
    #define DC_C CdigitalWrite(TFT_DC, LOW)
    #define DC_D CdigitalWrite(TFT_DC, HIGH)
  #elif defined (ESP32)
  ...
  #define CS_H // No macro allocated so it generates no code
    ...
    #define CS_L CdigitalWrite(TFT_CS, LOW)
    #define CS_H CdigitalWrite(TFT_CS, HIGH)
  #elif defined (ESP32)
    #if defined (ESP32_PARALLEL)
...
// chip select signal for touchscreen
...
#else
  #define T_CS_L CdigitalWrite(TOUCH_CS, LOW)
  #define T_CS_H CdigitalWrite(TOUCH_CS, HIGH)
#endif
  ...
  #define tft_Write_32(C) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = set_mask((uint8_t) (C >> 24)); WR_H; \
    ...
    //#define RD_L CdigitalWrite(TFT_WR, LOW)
    #define RD_H GPIO.out_w1ts = (1 << TFT_RD)
    //#define RD_H CdigitalWrite(TFT_WR, HIGH)
  #endif
...
//#include "Extensions/Sprite.h"  // directly included for maker watch
